...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/SkateWarp/proxmox-scripts/main/create.sh)"
```
...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/SkateWarp/proxmox-scripts/main/create.sh)" -s --app nginx-proxy-manager --cleanup
```
...
```sh
sh -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/SkateWarp/proxmox-scripts/main/install.sh)" -s --app nginx-proxy-manager
```
